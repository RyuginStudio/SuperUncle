...
Scene* LivesScene::createScene()               //需要在此场景中确定接下来跳转到哪个关卡，拟用switch...case实现
{
...
bool LivesScene::init()
{
	...
	this->scheduleOnce(CC_CALLBACK_1(LivesScene::missionJump, this), 3.f, "jumpToMissionScene");  //3秒后跳转至关卡
