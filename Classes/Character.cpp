...
Character::Character()
{
	...
	sp_man = Sprite3D::create("3Dsprite&action/sprite_stand.c3b");  //精灵素材，配合素材文件使用
...
{
	auto animation_bone = Animation3D::create("3Dsprite&action/run_to_stand_final.c3b");  //获取骨骼信息
